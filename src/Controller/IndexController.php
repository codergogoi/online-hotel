...
class IndexController extends AbstractController
{
    ...
    private const HOTEL_STARTED = 1969;
    ...
    public  function home(LoggerInterface $logger, DateCalculator $dateCalculator){
        ...
        $year = $dateCalculator->yearDifference(self::HOTEL_STARTED);

        $hotels = $this->getDoctrine()->getRepository(Hotel::class)->findAllBelowPrice(750);
